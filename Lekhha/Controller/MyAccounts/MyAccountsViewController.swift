...
class MyAccountsViewController: UIViewController , sentname , UITextFieldDelegate, GMSAutocompleteViewControllerDelegate,GMSMapViewDelegate{
    ...
    @IBOutlet weak var accountUsersTF: UITextField!
    ...
    var getAccountConsumerDataArr = [GetAccountConsumerResultVo]()
    ...
    @IBAction func emailBtn(_ sender: UIButton) {
        ...
        selectAccountAPI(sender: sender)
    }
...
//        present(autocompleteController, animated: true, completion: nil)
    ...
    var addAccDetailsArray = [String]()
    var addAccIDArray = [String]()
    var addAccPrimaryUserArray = [String]()
...
//        self.navigationController?.popViewController(animated: true)
    ...
    @objc func doneBtnTap(_ sender: UIButton) {
        ...
        dobSTR = formatter.string(from: picker.date)
...
//    var addressStr = NSString()
    ...
    func sendnamedfields(fieldname: String, idStr: String) {
        ...
        for i in 0..<selectAccResulDatatArr.count {
            ...
            print(selectAccResulDatatArr[i].primaryUser)
...
//            let dataDict = accDetailsArr![0] as! NSDictionary
            ...
            print(accIDStr)
            print(accDetailsDict?.emailAddress ?? "")
...
//                let accDict = emailAddressArray[0] as! NSDictionary
                ...
                let primaryUser=selectAccResulDatatArr[i].primaryUser
...
//            self.accountNameTF.isUserInteractionEnabled = true
            self.accountUsersTF.isUserInteractionEnabled = true
//            self.phoneNumTF.isUserInteractionEnabled = true
            ...
            addressOneTF.backgroundColor = .clear
            addressTwoTF.backgroundColor = .clear
            streetTF.backgroundColor = .clear
            cityTF.backgroundColor = .clear
            pinCodeTF.backgroundColor = .clear
            landmarkTF.backgroundColor = .clear
            accountNameTF.backgroundColor = .clear
            accountUsersTF.backgroundColor = .clear
            phoneNumTF.backgroundColor = .clear
            firstNameTF.backgroundColor = .clear
            lastNameTF.backgroundColor = .clear
            emailTF.backgroundColor = .clear
            lastNameTF.backgroundColor = .clear
            lastNameTF.backgroundColor = .clear
            stateTF.backgroundColor = .clear
            
            addressOneView.backgroundColor = .clear
            addressTwoView.backgroundColor = .clear
            streetView.backgroundColor = .clear
            cityView.backgroundColor = .clear
            stateView.backgroundColor = .clear
            pinCodeView.backgroundColor = .clear
            landMarkView.backgroundColor = .clear
            accountNameView.backgroundColor = .clear
            accountUsersView.backgroundColor = .clear
           
            emailTF.backgroundColor = .clear
            dobTF.backgroundColor = .clear
...
//          firstNameTF.becomeFirstResponder()
            ...
            self.addressOneView.layer.cornerRadius = 5
            self.addressOneView.layer.borderWidth = 0
            self.addressOneView.clipsToBounds = true
            
            self.addressTwoView.layer.cornerRadius = 5
            self.addressTwoView.layer.borderWidth = 0
            self.addressTwoView.clipsToBounds = true
            
            self.streetView.layer.cornerRadius = 5
            self.streetView.layer.borderWidth = 0
            self.streetView.clipsToBounds = true
            
            self.cityView.layer.cornerRadius = 5
            self.cityView.layer.borderWidth = 0
            self.cityView.clipsToBounds = true
            
            self.stateView.layer.cornerRadius = 5
            self.stateView.layer.borderWidth = 0
            self.stateView.clipsToBounds = true
            
            self.pinCodeView.layer.cornerRadius = 5
            self.pinCodeView.layer.borderWidth = 0
            self.pinCodeView.clipsToBounds = true
            
            self.landMarkView.layer.cornerRadius = 5
            self.landMarkView.layer.borderWidth = 0
            self.landMarkView.clipsToBounds = true
            
            self.accountNameView.layer.cornerRadius = 5
            self.accountNameView.layer.borderWidth = 0
            self.accountNameView.clipsToBounds = true
            
            self.accountUsersView.layer.cornerRadius = 5
            self.accountUsersView.layer.borderWidth = 0
            self.accountUsersView.clipsToBounds = true
            
            self.emailBtn.layer.cornerRadius = 5
            self.emailBtn.layer.borderWidth = 0.5
            self.emailBtn.clipsToBounds = true
            ...
            self.accountUsersTF.isUserInteractionEnabled = false
            ...
            addressOneView.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            addressTwoView.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            streetView.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            cityView.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            pinCodeView.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            landMarkView.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            accountNameView.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            accountUsersView.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            firstNameTF.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            lastNameTF.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
//            emailBtn.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
            stateView.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
//            stateBtn.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
//            dobBtn.backgroundColor = hexStringToUIColor(hex: "e8e8f0")
...
//           alertController.addAction(alertAction1)
    ...
    func parseAccDetailsData(sender:UIButton) {
        
        print(selectAccResulDatatArr)
        
        addAccDetailsArray = [String]()
        addAccIDArray = [String]()
        addAccPrimaryUserArray = [String]()
...
//            let dataDict = accDetailsArr![0] as! NSDictionary
            ...
            addAccDetailsArray.append(accDetailsDict?.emailAddress ?? "")
            addAccIDArray.append(accDetailsDict?._id ?? "")
            addAccPrimaryUserArray.append(selectAccResulDatatArr[i].primaryUser ?? "")

        }
        
        print(addAccDetailsArray)
        dropDown.dataSource = addAccDetailsArray //4
            dropDown.anchorView = sender //5
            dropDown.bottomOffset = CGPoint(x: 0, y: sender.frame.size.height) //6
            dropDown.show() //7
            dropDown.selectionAction = { [weak self] (index: Int, item: String) in //8
              guard let _ = self else { return }
                print(item,self?.addAccIDArray[index])
                self?.sendnamedfields(fieldname:item, idStr: self?.addAccIDArray[index] ?? "")
            }
...
//              self.present(VC, animated: true, completion: nil)
    ...
    override func viewDidLoad() {
        ...
        self.addressOneView.layer.cornerRadius = 5
        self.addressOneView.layer.borderWidth = 0.5
        self.addressOneView.clipsToBounds = true
        
        self.addressTwoView.layer.cornerRadius = 5
        self.addressTwoView.layer.borderWidth = 0.5
        self.addressTwoView.clipsToBounds = true
        
        self.streetView.layer.cornerRadius = 5
        self.streetView.layer.borderWidth = 0.5
        self.streetView.clipsToBounds = true
        ...
        self.stateView.layer.cornerRadius = 5
        self.stateView.layer.borderWidth = 0.5
        self.stateView.clipsToBounds = true
        
        self.pinCodeView.layer.cornerRadius = 5
        self.pinCodeView.layer.borderWidth = 0.5
        self.pinCodeView.clipsToBounds = true
        
        self.landMarkView.layer.cornerRadius = 5
        self.landMarkView.layer.borderWidth = 0.5
        self.landMarkView.clipsToBounds = true
        
        self.accountNameView.layer.cornerRadius = 5
        self.accountNameView.layer.borderWidth = 0.5
        self.accountNameView.clipsToBounds = true
        
        self.accountUsersView.layer.cornerRadius = 5
        self.accountUsersView.layer.borderWidth = 0.5
        self.accountUsersView.clipsToBounds = true
...
//        addressOneView.backgroundColor = .red
        if #available(iOS 13.0, *) {
            addressOneTF.backgroundColor = .systemBackground
        } else {
            addressOneTF.backgroundColor = .none
            // Fallback on earlier versions
        }
...
//            self.isSearchLocation = true
            ...
            self.AddOneStr = placemark?.thoroughfare ?? ""
            self.AddTwoStr = placemark?.subThoroughfare ?? ""
            self.streetAdd = placemark?.subLocality ?? ""
            ...
            for obj in self.statesCodesArr {
                ...
                if stateCode == "\(placemark?.administrativeArea ?? "")" {
                    self.stateValue = self.statesNamesArr[i]
                    self.stateId = self.statesIdsArr[i]
                }
                i += 1
            }
...
//          yyyy-MM-dd'T'HH:mm:ssZ   "yyyy-MM-dd HH:mm:ss"
    ...
    @objc func updateBtnTap(sender: UIButton!) {
        ...
        else if(isValidPassword(passwordStr: newPwdTF.text ?? "") == false){
...
//        marker.snippet = "Australia"
    ...
    func showAlertMsg(message:String)  {
                ...
                let alertAction = UIAlertAction(title: "OK", style: .default, handler: { (action) in
                    let userDefaults = UserDefaults.standard
                    userDefaults.set("Account Approvals", forKey: "sideMenuTitle")
                    userDefaults.synchronize()
                    let storyBoard = UIStoryboard(name: "Main", bundle: nil)
...
//        userID = "5f6d80e4950eaf1c4bfea973"
                    ...
                    let URLString_loginIndividual = Constants.BaseUrl + MyAccountUrl + userID
...
//            OKBtn.backgroundColor = UIColor.orange
    ...
    */
    ...
    @objc func locationSubmitBtnTap(sender: UIButton!){
        ...
        self.addressOneTF.text = self.addressStr
        self.addressTwoTF.text = self.AddTwoStr
        self.streetTF.text = self.streetAdd
        self.cityTF.text = self.cityStr
        self.pinCodeTF.text = self.pincodeStr
        self.stateTF.text = self.stateValue
...
//        self.locationTF.removeFromSuperview()
    ...
    func selectAccountAPI(sender:UIButton) {
...
//                                let dict = selectAccResultArr?[0] as! NSDictionary
                                ...
                                self.parseAccDetailsData(sender: sender)
    ...
    func getConsumerAccountDetailsAPI() {
        ...
        getAccountConsumerDataArr = [GetAccountConsumerResultVo]()
        ...
        accountID = (defaults.string(forKey: "accountId") ?? "")
                    ...
                    let URLString_loginIndividual = Constants.BaseUrl + GetAllAccountsConsumerUrl + accountID + "/" + userID
                                
//                                    let postHeaders_IndividualLogin = ["":""]
                                    
                    myAccServerCntrl.requestGETURL(strURL: URLString_loginIndividual, success: {(result) in

                            let respVo:GetAccountConsumerDetailsRespVo = Mapper().map(JSON: result as! [String : Any])!
...
//                                self.showAlertWith(title: "Alert", message: messageResp ?? "")
    ...
    func getConsumerAccountDetails(){
        ...
        for obj in getAccountConsumerDataArr {
            ...
            let locDict = obj.accountDetails?.loc
            let locArray = locDict?.coordinates
            
            self.latt = locArray?[0] as? Double ?? 17.4932682
            self.long = locArray?[1] as? Double ?? 78.3913929
            
            print("self.latt",self.latt)
    ...
    //        marker.snippet = "Australia"
            ...
            self.accountNameTF.text = obj.accountDetails?.accountUniqueId ?? ""
            self.accountUsersTF.text = obj.accountDetails?.companySize ?? ""
...
//            let selectedDate = dateFormatter.string(from: obj.userDetails?.dateOfBirth!)
            ...
            let dobStr = obj.userDetails?.dateOfBirth ?? ""
            let joinStr = self.convertDateFormater(dobStr)
            if joinStr != "" {
                dobSTR = joinStr
                self.dobTF.text = "\(joinStr)"
            }
            else {
                self.dobTF.text = dobStr
                dobSTR = dobStr
            }
...
//        userID = "5f6d80e4950eaf1c4bfea973"
                ...
                let URLString_loginIndividual = Constants.BaseUrl + "endusers/user_update"
                    ...
                    var params_IndividualLogin = [
                        ...
                        "companyName":accountNameTF.text ?? "",
                        "companySize":accountUsersTF.text ?? ""
                        ] as [String : Any]
...
//                        let statusCode = respVo.statusCode
                        ...
                        if status == "SUCCESS" {
                            ...
                            self.getMyAccDetails()
                            self.getConsumerAccountDetailsAPI()
...
//          print(params_IndividualLogin)
                    ...
                    myAccServerCntrl.requestPOSTURL(strURL: URLString_loginIndividual as NSString, postParams: params_IndividualLogin as NSDictionary, postHeaders: postHeaders_IndividualLogin as NSDictionary, successHandler: { (result) in
                        ...
                        if statusCode == 200 {
                            if status == "SUCCESS" {
                                self.updatePwdView.removeFromSuperview()
...
extension MyAccountsViewController:UIImagePickerControllerDelegate,UINavigationControllerDelegate {
