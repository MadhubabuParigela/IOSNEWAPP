//
//  IntroSignInViewController.swift
//  Lekhha
//
...
class IntroSignInViewController: UIViewController,UIScrollViewDelegate {
...
//        }
    ...
    @IBAction func onClickPaginationClick(_ sender: Any) {
    }
    @IBOutlet var paginationView: UIPageControl!
