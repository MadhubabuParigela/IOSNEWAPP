...
class CountryRespVo: Mappable {
        
    var message:String?
    var result:[CountryResultVo]?
    var status:String?
    var statusCode:Int?
    
    init(message:String?,result:[CountryResultVo]?,status:String?,statusCode:Int?) {
...
class CountryResultVo: Mappable {
    ...
    init( _id: String?,
          countryCode: String?,
          countryName: String?,networkCode: String?) {
...
/*
 {"STATUS_CODE":200,"STATUS_MSG":"SUCCESS","result":[{"_id":"6204fb4bbc1c3b2bf05e3e44","countryCode":"US","countryName":"USA"},{"_id":"6204fb12c18cd42bf0cb6a6b","countryCode":"IND","countryName":"India"}]}
 */
//
